...
public class BlogsAdapter extends RecyclerView.Adapter<BlogsAdapter.MyViewHolder> {
    ...
    public BlogsAdapter(ArrayList<BlogsModel> blogs, Context mCtx, OnItemClicked onItemClicked) {
        this.blogs = blogs;
        this.mCtx = mCtx;
    ...
    @Override
    public void onBindViewHolder(final BlogsAdapter.MyViewHolder holder, final int position) {
